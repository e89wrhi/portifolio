...
export default function CFASection() {
  return (
    <section className="relative overflow-hidden py-32 lg:py-48 bg-white dark:bg-gray-950">
      ...
      <div className="container relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center px-4">
        ...
        >
          Ready to bring your vision to life? Let's connect and explore how we can turn your ideas into reality.
        </motion.p>
        ...
        >
          <Link href="mailto:hello@example.com" className="w-full sm:w-auto">
            <Button size="lg" className="w-full rounded-full px-8 h-14 text-base font-medium shadow-sm transition-all hover:-translate-y-0.5">
              <Icons.mail className="mr-2 h-5 w-5" />
              Email Me
            </Button>
          </Link>

          <Link href="https://wa.me/something" target="_blank" rel="noreferrer" className="w-full sm:w-auto">
            <Button variant="outline" size="lg" className="w-full rounded-full px-8 h-14 text-base font-medium border-gray-200 dark:border-gray-800 bg-transparent transition-all hover:-translate-y-0.5 hover:bg-gray-50 dark:hover:bg-gray-900">
