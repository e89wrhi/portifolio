          ...
          <div className="group relative aspect-video overflow-hidden rounded-3xl border border-border/50 bg-muted/20 transition-all hover:border-border hover:bg-muted/40">
            <Link href="/project" className="block size-full relative">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background/60 to-transparent p-8 opacity-0 transition-opacity group-hover:opacity-100">
                ...
                <p className="text-muted-foreground">Explore my full portfolio of work.</p>
              </div>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
            ...
            >
              <div className="flex-1 p-8 flex flex-col justify-center gap-4">
                <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Prompt Engineering</span>
                <h3 className="text-3xl font-extrabold tracking-tight">PromptMaster</h3>
                <p className="text-muted-foreground text-lg leading-relaxed line-clamp-3">
                  Enterprise-grade repository of high-performance prompt engineering templates utilizing strict frameworks.
                </p>
                <div className="pt-2">
                   <span className="text-sm font-semibold underline underline-offset-4">View Details →</span>
                </div>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Advanced AI features powered by .NET Core.</p>
              </div>
            </Link>
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-sm text-muted-foreground text-balance">Toolkit for autonomous agents.</p>
              </div>
