...
import { ogImageSchema } from '@/lib/ogImage';
...
export async function GET(req: Request) {
  try {
    ...
    return new ImageResponse(
      (
        <div
          className="flex relative flex-col p-12 w-full h-full items-start"
          style={{
            color: paint,
            background:
              mode === 'dark'
        ...
        >
          ...
          <div className="flex flex-col flex-1 py-16">
            {/* Type : Blog or Doc */}
            <div
              className="flex text-xl uppercase font-bold tracking-tight"
            ...
            {/* Title */}
            <div
              className="flex leading-[1.15] text-[80px] font-bold"
              style={{
                fontFamily: 'Cal Sans',
                fontWeight: 'bold',
                marginLeft: '-3px',
          ...
          <div className="flex items-center w-full justify-between">
            ...
            >
              ...
              <div className="flex flex-col" style={{ marginLeft: '15px' }}>
                <div className="text-[22px]" style={{ fontFamily: 'Cal Sans' }}>
                  {githubName}
                </div>
